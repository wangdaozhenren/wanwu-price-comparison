  ...
  "items": [
    {
      ...
      "price_records": [
        {"date": "2026-09-17", "price": 55.9, "platform": "jd", "url": "<商品URL>", "title": "可口可乐...24罐"}
      ],
      "price_alerts": [
...
# 追加价格记录（比价采集后调用）
python scripts/items_manager.py record data/items.json --id a1b2c3d4 --price 52.9 --platform jd --url <商品URL>
